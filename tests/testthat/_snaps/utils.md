...
# .check_function_names blocks unpermitted function names
    ...
    Condition
      ...
      i Permitted functions are everything, last_col, group_cols, starts_with, ends_with, contains, matches, num_range, all_of, any_of, where, rename, mutate, if_else, case_when, mean, median, mode, ..., cumsum, and is.na.
